          ...
          >
            ...
            >
              <View
                ...
                {...getOverrideProps(
                  overrides,
                  "Flex.Flex[0].Flex[1].Flex[0].Flex[1].View[0]"
                )}
              >
                <Icon
                  width="30px"
                  ...
                  {...getOverrideProps(
                    overrides,
                    "Flex.Flex[0].Flex[1].Flex[0].Flex[1].View[0].Icon[0]"
                  )}
                ></Icon>
              </View>
              <Text
          ...
          >
            ...
            >
              <View
                ...
                {...getOverrideProps(
                  overrides,
                  "Flex.Flex[0].Flex[1].Flex[1].Flex[1].View[0]"
                )}
              >
                <Icon
                  width="30px"
                  ...
                  {...getOverrideProps(
                    overrides,
                    "Flex.Flex[0].Flex[1].Flex[1].Flex[1].View[0].Icon[0]"
                  )}
                ></Icon>
              </View>
              <Text
